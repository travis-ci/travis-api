...
gem 'travis-lock',     git: 'https://github.com/travis-ci/travis-lock/', branch: 'master'
gem 'travis-github_apps', git: 'https://github.com/travis-ci/travis-github_apps', branch: 'master'
...
gem 'aws-sdk-s3'
gem 'activerecord',      '~> 7.0.6' # it was fixed in predicate_builder file to 7.0.6 but gh gem requires 7.0.8
