module Travis::API::V3
  class Renderer::Repository < ModelRenderer
    ...
    representation(:standard, :id, :name, :slug, :description, :vcs_id, :vcs_type, :github_language, :active, :private, :owner, :default_branch, :starred, :managed_by_installation, :active_on_org, :migration_status, :history_migration_status)
