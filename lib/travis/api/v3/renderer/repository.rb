module Travis::API::V3
  class Renderer::Repository < ModelRenderer
    ...
    representation(:standard, :id, :name, :slug, :description, :github_id, :vcs_id, :type_vcs, :github_language, :active, :private, :owner, :default_branch, :starred, :managed_by_installation, :active_on_org, :migration_status)
    representation(:experimental, :id, :name, :slug, :description, :github_id, :vcs_id, :type_vcs, :github_language, :active, :private, :owner, :default_branch, :starred, :current_build, :last_started_build, :next_build_number)
