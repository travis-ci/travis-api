...
module Travis::API::V3
  class Renderer::Job < ModelRenderer
    ...
    representation(:standard, *representations[:minimal], :allow_failure, :number, :name, :state, :started_at, :finished_at, :build, :queue, :repository, :commit, :owner, :stage, :created_at, :updated_at, :private)
    ...
    representation(:with_config, *representations[:minimal], :allow_failure, :number, :name, :state, :started_at, :finished_at, :build, :queue, :repository, :commit, :owner, :stage, :created_at, :updated_at, :config)
