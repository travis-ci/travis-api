module Travis::API::V3
  class Renderer::Request < ModelRenderer
    ...
    representation(:standard, *representations[:minimal], :repository, :branch_name, :commit, :builds, :owner, :created_at, :event_type, :base_commit, :head_commit, :pull_request_mergeable)
