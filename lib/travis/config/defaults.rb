...
module Travis
  class Config < Hashr
    ...
    define  host:                 'travis-ci.org',
            ...
            applications:         {},
            tokens:               { internal: 'token', web_token: { expires_in: ENV['WEB_TOKEN_EXPIRES_IN_DAYS'] ? ENV['WEB_TOKEN_EXPIRES_IN_DAYS'].to_i * 86_400 : 1 * 86_400 }, auth_token: { expires_in: ENV['AUTH_TOKEN_EXPIRES_IN_DAYS'] ? ENV['AUTH_TOKEN_EXPIRES_IN_DAYS'].to_i * 86_400 : 90 * 86_400 } },
