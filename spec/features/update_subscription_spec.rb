...
RSpec.feature 'Update subscription information', js: true, type: :feature do
  ...
  let!(:subscription) { create :subscription, owner: user, cc_token: 'tok_1076247Biz',
                               valid_to: 1.week.from_now, vat_id: 'DE999999999',
                               billing_email: 'contact@travis-ci.com', selected_plan: 'travis-ci-five-builds'}
