  ...
  describe 'authenticated, existing repo, repo has no settings', focus: true do
    ...
    example do
      expect(JSON.load(body)).to eq(
        ...
        'user_settings' => [
          { '@type' => 'user_setting', '@representation' => 'standard', 'name' => 'builds_only_with_travis_yml', 'value' => false },
          { '@type' => 'user_setting', '@representation' => 'standard', 'name' => 'build_pushes', 'value' => true },
          { '@type' => 'user_setting', '@representation' => 'standard', 'name' => 'build_pull_requests', 'value' => true },
          { '@type' => 'user_setting', '@representation' => 'standard', 'name' => 'maximum_number_of_builds', 'value' => 0 }
        ]
      )
    end
  end
  ...
  describe 'authenticated, existing repo, repo has some settings' do
    ...
    example do
      expect(JSON.load(body)).to eq(
        ...
        'user_settings' => [
          { '@type' => 'user_setting', '@representation' => 'standard', 'name' => 'builds_only_with_travis_yml', 'value' => false },
          { '@type' => 'user_setting', '@representation' => 'standard', 'name' => 'build_pushes', 'value' => false },
          { '@type' => 'user_setting', '@representation' => 'standard', 'name' => 'build_pull_requests', 'value' => true },
          { '@type' => 'user_setting', '@representation' => 'standard', 'name' => 'maximum_number_of_builds', 'value' => 0 }
        ]
      )
