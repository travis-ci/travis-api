describe Travis::API::V3::Services::V2Subscription::UpdateCreditcard, set_app: true, billing_spec_helper: true do
  ...
  context 'unauthenticated' do
    it 'responds 403' do
      patch('/v3/v2_subscription/123/creditcard', { })
  ...
  context 'authenticated' do
    ...
    it 'updates the creditcard' do
      patch("/v3/v2_subscription/#{subscription_id}/creditcard", JSON.generate(creditcard_token), headers)
