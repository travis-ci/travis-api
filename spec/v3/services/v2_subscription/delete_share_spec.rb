describe Travis::API::V3::Services::V2Subscription::DeleteShare, set_app: true, billing_spec_helper: true do
  ...
  context 'unauthenticated' do
    it 'responds 403' do
      post('/v3/v2_subscription/123/delete_share', {})
  ...
  context 'authenticated' do
    ...
    it 'deletes subscription share' do
      post("/v3/v2_subscription/#{subscription_id}/delete_share", JSON.generate(data), headers)
