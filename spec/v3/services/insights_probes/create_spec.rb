describe Travis::API::V3::Services::InsightsProbes::Create, set_app: true, insights_spec_helper: true do
  ...
  context 'authenticated' do
    ...
    before do
      stub_insights_request(:post, '/probes', auth_key: insights_auth_key, user_id: user.id)
    ...
    it 'responds with list of subscriptions' do
      post('/v3/insights_probes', probe_data, headers)
