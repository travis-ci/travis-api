describe Travis::API::V3::Services::Repository::Find, set_app: true do
  ...
  shared_examples_for '200 standard representation' do |opts|
  ...
  shared_examples_for '400 wrong params' do |message|
  ...
  describe "public repository" do
    ...
    include_examples '200 standard representation', permissions: :anonymous, private: false
  end
  ...
  describe "private repository, private API, authenticated as user with access" do
    ...
    include_examples '200 standard representation', permissions: :authenticated, private: true
  end
